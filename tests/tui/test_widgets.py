...
class TestASCIIBanner:
    ...
    def test_banner_animation_setup(self, mock_set_interval):
        ...
        with AppTest(TestApp) as pilot:
            mock_set_interval.assert_called_with(0.5, pilot.app.query_one(ASCIIBanner).animate)
...
class TestSystemMonitor:
    ...
    def test_system_monitor_update_stats(self, mock_net, mock_disk, mock_memory, mock_cpu):
    ...
    def test_create_memory_panel(self):
        ...
        with patch('psutil.virtual_memory', return_value=Mock(used=1000000, total=2000000)):
    ...
    def test_create_disk_panel(self):
        ...
        with patch('psutil.disk_usage', return_value=Mock(used=500000, free=500000, total=1000000)):
