...
def demo_widgets():
    ...
    print(f"  • After completing 1: active={crypto_monitor.active_operations}, completed={crypto_monitor.completed_operations}")
    
    crypto_monitor.add_operation("decrypt", "failed")
    print(f"  • After failing 1: active={crypto_monitor.active_operations}, failed={crypto_monitor.failed_operations}")
    print()
...
def demo_cli_integration():
    ...
    cli_commands = [
        ...
        "crypto (gen-cc, gen-keys, encrypt, decrypt, re-encrypt)",
