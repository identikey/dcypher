...
async fn show() -> Result<()> {
    ...
    println!(
        "    {}",
        "Example: alice (set with: dcypher identity use <name>)".bright_black()
    );
    ...
    println!("  dcypher config set <key> <value>");
        ...
        _ => {
            anyhow::bail!(
                ...
                Valid keys:\n  \
                  ...
                  active_identity     (e.g., alice) [use 'dcypher identity use' instead]\n  \
